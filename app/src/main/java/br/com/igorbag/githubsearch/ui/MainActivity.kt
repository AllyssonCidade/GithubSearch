...
class MainActivity : AppCompatActivity() {
    ...
    private fun saveUserLocal() {
        ...
        with(sharedPref.edit()) {
            putString(getString(R.string.saved_username), nomeUsuario)
            apply()
        }
    }
    ...
    private fun showUserName() {
        ...
        sharedPref.getString(getString(R.string.saved_username), "")?.let {
            ...
            githubApi.getAllRepositoriesByUser(userName).enqueue(object : Callback<List<Repository>> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        Toast.makeText(applicationContext, "Erro ao buscar os repositórios", Toast.LENGTH_SHORT).show()
                    }
                }
    ...
    fun setupAdapter(list: List<Repository>) {
        ...
        adapter.repoItemLister = { repository ->
